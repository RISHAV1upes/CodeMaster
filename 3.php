...
<div class="container">
<h3 style="color:;font-family:Times New Roman;">Question 3:-<br>I thought you used vinegar to preserve your food items.<br>
     Passphrase:- CodeMaster<br>
     Ciphered text:- acxedeseytmmsidsgg
</h3><br>
<form class="" action="q3.php" method="post">
  <div class="form-group">
    <label for="txtarea2" class="col-sm-2 control-label" style="color:;"><h3>Answer</h3></label>
    <div class="col-sm-8"><textarea name="txtarea" id="txtarea3" cols="50" rows="10000000" class="form-control1" style="height:285px; margin-bottom:30px;"><?php echo $ans2[0]; ?></textarea></div>
