...
<div align="right">Time Left : <span id="time">30:00</span> minutes!</div>
<div class="categories">
<div class="container">
<h3 style="color:;font-family:Times New Roman;">Question 5:-<br>Ramesh wants to make a webpage in which he can edit the content in browser and after every instance,i.e either being written or deleted,new text should be saved in such a way 
that on reloading the webpage also display the edited text.Make a button also to clear the edited text and set it once again in default instant.Design the page to help out to Ramesh.
</h3><br>
<form class="" action="q5.php" method="post">
  <div class="form-group">
    <label for="txtarea5" class="col-sm-2 control-label" style="color:;"><h3>Answer</h3></label>
	
    <div class="col-sm-8" id="col-sm-10"  style="height:338px;font-size:20px;"  > </div>
    <div class="col-sm-8"><textarea name="txtarea" id="txtarea5" cols="50" rows="10000000" class="form-control1" style="display:none;"><?php echo $ans2[0]; ?></textarea></div>
