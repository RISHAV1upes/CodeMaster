...
<div class="container">
<h3 style="font-family:Times New Roman;">Question 8:-<br>The string “PAYTMAMAZON” is written in ziz zag and in a given number of row.<br>
                   P<span style="margin-left:40px;"> M </span>  <span style="margin-left:40px;">    Z</span><br>
				   A <span style="margin-left:10px;">T</span> <span style="margin-left:10px;">  A </span> <span style="margin-left:10px;"> A</span> <span style="margin-left:10px;">  O</span><br>
				   Y <span style="margin-left:40px;">    M </span> <span style="margin-left:40px;">   N</span> <br>
				   The line will be read in way “PMZATAAOYMN”.<br>			   
                   Write the method to convert (“PAYTMAMAZON”,3) which returns “PMZATAAOYMN”.
</h3><br>
...
<form class="" action="q8.php" method="post">
  <div class="form-group col-sm-10">
    ...
    <label for="txtarea8" class="control-label col-sm-1" style="margin-right:60px;"><h3>Answer</h3></label>
	<div class="col-sm-10" id="col-sm-10"  style="height:500px;font-size:20px;"  > </div>
    <div><textarea name="txtarea" type="hidden" class="col-sm-10" id="txtarea8" cols="50" rows="10000000" class="form-control1" style="display:none;"><?php echo $ans2[0]; ?></textarea></div>
...
<div class="bottom-footer">
    ...
    editor.getSession().on('change', function () {
      document.getElementById("txtarea8").value= editor.getSession().getValue(); 
