...
<div class="container">
<h3 style="color:;font-family:Times New Roman;">Question 6:-<br>Create a web application to display details of github users profile by searching from their username.
</h3><br>
<form class="" action="q6.php" method="post">
  <div class="form-group">
    <label for="txtarea6" class="col-sm-2 control-label" style="color:;"><h3>Answer</h3></label>
	
    <div class="col-sm-8" id="col-sm-10"  style="height:425px;font-size:20px;"  > </div>
    <div class="col-sm-8"><textarea name="txtarea" type="hidden" id="txtarea6" cols="50" rows="10000000" class="form-control1" style="display:none;"><?php echo $ans2[0]; ?></textarea></div>
...
<div class="bottom-footer">
    ...
    editor.getSession().on('change', function () {
      document.getElementById("txtarea6").value= editor.getSession().getValue(); 
