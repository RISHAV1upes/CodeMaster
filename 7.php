...
<div class="container">
<h3>Question 7:-<br>The series before sorting:- 9 16 27 39 32 1 57 92 3 31
                <br> The series after sorting :-  9 16 1 31 32 3 39 92 27 57
<br>Identify the sorting used and compute a code for this sorting to perform  operation mentioned above.<br>
...
<form class="" action="q7.php" method="post">
  <div class="form-group col-sm-10">
    ...
    <label for="txtarea7" class="control-label col-sm-1" style="margin-right:60px;"><h3>Answer</h3></label>
	<div class="col-sm-10" id="col-sm-10"  style="height:500px;font-size:20px;"  > </div>                             
                                
    <div><textarea name="txtarea" type="hidden" class="col-sm-10" id="txtarea7" cols="50" rows="10000000" class="form-control1" style="display:none;"><?php echo $ans2[0]; ?></textarea></div>
...
<div class="bottom-footer">
    ...
    editor.getSession().on('change', function () {
      document.getElementById("txtarea7").value= editor.getSession().getValue(); 
